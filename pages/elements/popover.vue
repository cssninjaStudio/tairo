...
import { breadcrumb, toc } from '@@/documentation/elements/popover/toc'
import {
  dualLeft,
  dualRight,
  helpLeft,
  ...
  mediaLeft,
  mediaRight,
} from '@@/documentation/elements/popover'
import {
  dualProperties,
  helpProperties,
  mediaProperties,
  properties,
} from '@@/documentation/elements/popover/properties'
                      ...
                      :stats="[
                        {
                          ...
                          image:
                            'https://vuero.cssninja.io/images/icons/stacks/js.svg',
                        },
                        {
                          title: 'Projects',
