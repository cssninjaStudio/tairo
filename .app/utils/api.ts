...
function isAnyTaskFinished(pending_task_ids: number, progress_task_ids: number, all_tasks: number) {
...
function isTaskUpdated(taskId: number, lastUpdated: number, status: number) {
...
function downloadViaLink(response: any) {
...
function downloadTaskResults(taskId: number, data = {}) {
...
function getTaskResults(taskId: number, data = {}, force_apply_first_view = false) {
