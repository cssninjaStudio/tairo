    ...
    <BaseCard>
      ...
      >
        ...
        <div class="ms-auto flex items-center gap-2">
          ...
          <BaseButtonAction color="primary">
          ...
          <div class="col-span-12 grid grid-cols-12">
            ...
            <div class="col-span-12 sm:col-span-9">
              <div class="flex flex-col gap-6">
                <BaseCheckbox color="primary" label="General notifications" />
                <BaseCheckbox color="primary" label="Team notifications" />
                <BaseCheckbox color="primary" label="Auto reminders" />
                <BaseCheckbox color="primary" label="Modifications" />
              </div>
            </div>
          </div>
        </div>
