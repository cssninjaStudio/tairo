      ...
      <MenuButton as="template">
        <div>
          ...
          >
            ...
            <BaseIcon
              name="lucide:chevron-down" class="w-4 h-4 text-slate-400 transition-transform duration-300"
          ...
          >
            ...
            >
              <BaseIcon
                name="lucide:more-horizontal" class="w-5 h-5 text-slate-400 transition-transform duration-300"
