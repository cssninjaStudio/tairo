...
<template>
  <label :for="props.id" class="flex items-center cursor-pointer">
    <span class="block relative">
      ...
      />
      <span
        class="absolute z-10 flex items-center justify-center w-5 h-5 focus:w-6 border border-gray-300 bg-white dark:bg-gray-700 dark:border-gray-600 rounded-full shadow left-0.5 top-1/2 -translate-y-1/2 transition peer-checked:-translate-y-1/2 peer-checked:translate-x-full"
      ></span>
      <span
        class="block w-11 h-6 bg-gray-300 dark:bg-gray-600 rounded-full shadow-inner peer-focus:ring-0 outline-1 outline-transparent peer-focus:outline-dashed peer-focus:outline-gray-300 dark:peer-focus:outline-gray-600 peer-focus:outline-offset-2 transition-all duration-300"
        :class="[
