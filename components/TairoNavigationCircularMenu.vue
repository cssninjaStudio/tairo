...
const tools = computed(() => {
  return app.tairo.circularMenu.tools.slice(0, 4)
})
</script>

<template>
  <div
    class="after:bg-primary-600 after:shadow-primary-500/50 dark:after:shadow-muted-800/10 fixed top-[0.6em] right-[1em] z-[90] transition-transform duration-300 after:absolute after:top-0 after:right-0 after:block after:h-12 after:w-12 after:rounded-full after:shadow-lg after:transition-transform after:duration-300 after:content-['']"
    :class="[
      isOpened
