...
<template>
  <div class="group text-right inline-flex justify-center items-center">
    <Menu as="div" class="relative w-9 h-9 text-left">
      ...
      >
        <MenuItems
          class="absolute right-0 mt-2 w-64 origin-top-right divide-y divide-gray-100 rounded-md bg-white border border-gray-200 shadow-lg focus:outline-none"
        >
          ...
          <div class="py-1.5 px-6">
            <MenuItem v-slot="{ active }">
              ...
              >
                ...
                <div class="ml-2">
                  ...
                  <p class="font-text text-xs text-slate-400">mike@tairo.io</p>
                </div>
              </NuxtLink>
            </MenuItem>
            <MenuItem v-slot="{ active }">
              ...
              >
                ...
                >
                  <img
                    src="https://media.cssninja.io/shuriken/avatars/9.svg"
                    class="object-cover max-w-full rounded-full dark:border-transparent shadow-sm"
                    alt="Avatar image"
                  />
                </div>
            ...
            <MenuItem v-slot="{ active }">
              ...
              >
                ...
                >
                  <img
                    src="https://media.cssninja.io/shuriken/avatars/14.svg"
                    class="object-cover max-w-full rounded-full dark:border-transparent shadow-sm"
                    alt="Avatar image"
                  />
                </div>
                <div class="ml-2">
                  ...
                  <p class="font-text text-xs text-slate-400">alan@tairo.io</p>
                </div>
              </NuxtLink>
            </MenuItem>
          </div>
