  ...
  >
    ...
    >
      ...
      >
        ...
        <span
          ...
          :class="isOpened ? 'opacity-0 tranmuted-x-4' : ''"
        ></span>
        <span
          class="absolute block w-full h-0.5 bg-muted-50 transition-all duration-300"
    ...
    <div>
      ...
      <div
        ...
        :class="
          isOpened
            ? 'tranmuted-x-[-6.5em] tranmuted-y-[-0.25em]'
            : 'tranmuted-x-0 tranmuted-y-0'
        "
      >
      ...
      <div
        ...
        :class="
          isOpened
            ? 'tranmuted-x-[-5.75em] tranmuted-y-[3em]'
            : 'tranmuted-x-0 tranmuted-y-0'
        "
      >
        <button
      ...
      <div
        ...
        :class="
          isOpened
            ? 'tranmuted-x-[-3.15em] tranmuted-y-[5.5em]'
            : 'tranmuted-x-0 tranmuted-y-0'
        "
      >
        <NuxtLink
      ...
      <div
        ...
        :class="
          isOpened
            ? 'tranmuted-x-[0em] tranmuted-y-[6.5em]'
            : 'tranmuted-x-0 tranmuted-y-0'
        "
      >
        <button
