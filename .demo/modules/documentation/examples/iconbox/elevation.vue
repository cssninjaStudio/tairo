<template>
  ...
  <BaseIconBox size="md" shape="full" class="bg-primary-500 shadow-primary-500/50 text-white shadow-lg">
  ...
  <BaseIconBox size="md" shape="full" class="bg-green-500 text-white shadow-lg shadow-green-500/50">
    <Icon name="ph:leaf-duotone" class="h-5 w-5" />
  </BaseIconBox>
  <BaseIconBox size="md" shape="full" class="bg-emerald-500 text-white shadow-lg shadow-emerald-500/50">
  ...
  <BaseIconBox size="md" shape="full" class="bg-indigo-500 text-white shadow-lg shadow-indigo-500/50">
    <Icon name="ph:drop-duotone" class="h-5 w-5" />
  </BaseIconBox>
  <BaseIconBox size="md" shape="full" class="bg-purple-500 text-white shadow-lg shadow-purple-500/50">
    <Icon name="ph:image-square-duotone" class="h-5 w-5" />
  </BaseIconBox>
  <BaseIconBox size="md" shape="full" class="bg-fuchsia-500 text-white shadow-lg shadow-fuchsia-500/50">
  ...
  <BaseIconBox size="md" shape="full" class="bg-orange-500 text-white shadow-lg shadow-orange-500/50">
    <Icon name="ph:pizza-duotone" class="h-5 w-5" />
  </BaseIconBox>
  <BaseIconBox size="md" shape="full" class="bg-amber-500 text-white shadow-lg shadow-amber-500/50">
    <Icon name="ph:sun-duotone" class="h-5 w-5" />
  </BaseIconBox>
  <BaseIconBox size="md" shape="full" class="bg-yellow-500 text-white shadow-lg shadow-yellow-500/50">
    <Icon name="ph:sketch-logo-duotone" class="h-5 w-5" />
  </BaseIconBox>
  <BaseIconBox size="md" shape="full" class="bg-muted-800 shadow-muted-500/50 text-white shadow-lg">
