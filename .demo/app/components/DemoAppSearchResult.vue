...
<template>
  <NuxtLink
    class="focus-visible:nui-focus hover:bg-muted-50 focus:bg-muted-50 dark:hover:bg-muted-900 dark:focus:bg-muted-900 group flex items-center rounded-sm p-3"
    :to="props.to"
  >
