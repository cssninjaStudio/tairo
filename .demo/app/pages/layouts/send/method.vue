    ...
    <div class="w-full max-w-md">
      <RadioGroupRoot v-model="request.method" class="w-full space-y-4">
        ...
        >
          ...
          <div
            class="dark:bg-muted-950 border-muted-200 dark:border-muted-800 group-data-[state=checked]:shadow-muted-400/10 dark:group-data-[state=checked]:shadow-muted-800/10 group-focus-visible:tw-accessibility-static group flex cursor-pointer items-center rounded-lg border bg-white px-6 py-4 transition-shadow duration-300 group-data-[state=checked]:shadow-xl"
          >
            <div
