...
<template>
  <div class="grid grid-cols-12 gap-4">
      ...
      <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-span-12 md:col-span-4">
          <BaseCard class="p-4">
            ...
            <div class="flex items-center gap-1 font-sans text-sm text-success-500">
              <span>+7.8%</span>
        ...
        <div class="col-span-12 md:col-span-4">
          <BaseCard class="p-4">
            ...
            <div class="flex items-center gap-1 font-sans text-sm text-danger-500">
              <span>-2.7%</span>
        ...
        <div class="col-span-12 md:col-span-4">
          <BaseCard class="h-full flex flex-col p-6">
            ...
            <div class="mt-auto">
              <div class="w-full flex text-center pt-4 border-t border-muted-200 dark:border-muted-700">
                <div class="flex-1 px-2 border-r border-muted-200 dark:border-muted-700">
                  <span class="font-sans text-xs text-muted-400">Completed</span>
                  <p class="font-sans font-medium text-lg text-muted-800 dark:text-muted-100">1431</p>
                </div>
                <div class="flex-1 px-2">
                  <span class="font-sans text-xs text-muted-400">In Progress</span>
                  <p class="font-sans font-medium text-lg text-muted-800 dark:text-muted-100">219</p>
                </div>
              </div>
            </div>
          </BaseCard>
    ...
    <div class="col-span-12 ltablet:col-span-3 lg:col-span-3">
      <!--Inner column -->
      <div class="grid ptablet:grid-cols-2 ltablet:flex ltablet:flex-col lg:flex lg:flex-col gap-4">
        <!-- Vcard -->
        <BaseCard class="p-6">
          <WidgetVcardRight />
        </BaseCard>
