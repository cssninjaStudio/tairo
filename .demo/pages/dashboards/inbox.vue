...
<template>
  ...
  >
    ...
    <!-- Messages list -->
    <div
      class="flex flex-col pt-3 w-full ltablet:max-w-[480px] lg:max-w-[480px] bg-muted-50 dark:bg-muted-900 h-full"
    >
      <!-- Head (search) -->
    ...
    >
      ...
      <div class="w-full ltablet:max-w-5xl lg:max-w-5xl mx-auto">
        ...
        <!-- Messsage reply -->
        <div class="relative w-full h-44 flex items-center justify-center px-8">
          <div
