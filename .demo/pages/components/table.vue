      ...
      <template #content>
        ...
        >
          <DocComponent label="Media straight table example">
            ...
            <template #code>
              <DocMarkdown :source="mediaStraight" class="prose max-w-2xl" />
            </template>
          </DocComponent>
        </DocSection>
        ...
        <DocSection title="Rounded media" tag="1.0.0">
          <DocComponent label="Media rounded table example">
            ...
            <template #code>
              <DocMarkdown :source="mediaRounded" class="prose max-w-2xl" />
            </template>
          </DocComponent>
        </DocSection>
        ...
        <DocSection title="Curved media" tag="1.0.0">
          <DocComponent label="Media curved table example">
            ...
            <template #code>
              <DocMarkdown :source="mediaCurved" class="prose max-w-2xl" />
            </template>
          </DocComponent>
        </DocSection>
