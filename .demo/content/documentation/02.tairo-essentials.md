...
[Shuriken UI :icon{name="nui-icon:shurikenui-icon" .inline .mb-1}](https://v4.shurikenui.com/) is a component library that provides a set of accessible and customizable components to build functional interfaces. It is designed to be easy to use and integrate with Nuxt.
...
- [Visit shurikenui.com](https://v4.shurikenui.com)
- [Read documentation guides](https://v4.shurikenui.com/docs)
