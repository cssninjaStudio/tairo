...
::doc-component-demo
---
title: What you can build with Tairo
---
Take a look at the [demos](/demos) available.
#grid
  :::doc-grid-icon{name="solar:users-group-rounded-linear"}
  HR
  ...
  :::doc-grid-icon{name="solar:wad-of-money-linear"}
  Banking
  ...
  :::doc-grid-icon{name="solar:suitcase-lines-linear"}
  Projects
  ...
  :::doc-grid-icon{name="solar:buildings-linear"}
  Real Estate
  ...
  :::doc-grid-icon{name="solar:pie-chart-2-linear"}
  Reporting
  ...
  :::doc-grid-icon{name="solar:suitcase-linear"}
  Business
  ...
  :::doc-grid-icon{name="solar:widget-6-linear"}
  Blockchain
  ...
  :::doc-grid-icon{name="solar:cart-large-minimalistic-linear"}
  Ecommerce
  ...
  :::doc-grid-icon{name="solar:layers-linear"}
  CRM
  ...
  :::doc-grid-icon{name="solar:help-linear"}
  Support
  ...
  :::doc-grid-icon{name="solar:widget-2-linear"}
  SaaS
  ...
  :::doc-grid-icon{name="solar:notebook-minimalistic-linear"}
  Content
