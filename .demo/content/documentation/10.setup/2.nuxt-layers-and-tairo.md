...
- **Tairo Layout Sidenav**: `layers/layout-sidenav`

  This layer provides a side navigation layout, with a more condensed menu area. It is ideal for internal tools with many links.
...
- **Tairo Layout Iconnav**: `layers/layout-iconnav`

  This layer provides a top navigation layout, with a list of tabbed links. It also provides two slots for the navbar header and toolbar.
