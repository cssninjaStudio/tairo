...
You can now navigate to the newly created project folder:
...
::code-group
```css [<app>/app/assets/css/main.css]
@import 'tailwindcss';
@import '@shuriken-ui/nuxt';
@import '#cssninja/tairo';
...
- [Theming on shurikenui.com](https://v4.shurikenui.com/docs/theming)
