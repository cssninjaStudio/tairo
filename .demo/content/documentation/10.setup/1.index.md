...
::doc-message{variant="destructive" icon="ph:warning"}
...
:::doc-message{variant="primary" icon="simple-icons:discord"}
...
The template is built with [Nuxt](https://nuxt.com/) and [Tailwind CSS](https://tailwindcss.com/). You need to have [Node.js LTS](https://nodejs.org/en/) installed on your machine.
