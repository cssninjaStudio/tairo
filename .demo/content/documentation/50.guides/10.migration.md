...
- `Base` components require a migration, see [Shuriken UI v4 Migration Guide](https://v4.shurikenui.com/docs/advanced/migration) for more information.
...
We recommend you to read the [Shuriken UI v4 Migration Guide](https://v4.shurikenui.com/docs/advanced/migration) to understand the changes as it contains major breaking changes that you will need to handle.
...
- [Shuriken UI v4 Migration Guide](https://v4.shurikenui.com/docs/advanced/migration)
