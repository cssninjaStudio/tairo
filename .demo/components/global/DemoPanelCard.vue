...
<template>
  ...
  >
    ...
    <div
      class="nui-slimscroll relative h-[calc(100%_-_80px)] w-full overflow-y-auto p-6"
    >
      <div class="mb-3">
        <!--Info-->
          ...
          <div class="border-muted-200 dark:border-muted-700 border-t">
            <div class="space-y-4 py-6">
              ...
              <div class="flex items-center justify-between">
                ...
                <NuxtLink
                  to="#"
                  class="text-muted-600 dark:text-muted-300 font-sans text-sm font-medium underline-offset-4 hover:underline"
