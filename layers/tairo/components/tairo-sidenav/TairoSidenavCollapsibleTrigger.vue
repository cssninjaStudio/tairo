...
<template>
  ...
  >
    ...
    <Icon
      ...
      class="relative ms-auto size-4 shrink-0 group-data-[state=open]:rotate-180 transition-transform duration-200"
    />
  </CollapsibleTrigger>
</template>
