...
::code-timeline{.mt-12}
  ...
  #title
  :tairo-toc-anchor{label="Create a new Nuxt project (or use an existing one)" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Add the Tairo layers from github" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Add your Github token" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Install dependencies with your package manager" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Run the development server" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Done!" prefix=" " level="3"}
...
::code-timeline{.mt-12}
  ...
  #title
  :tairo-toc-anchor{label="Download the source code" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Update the tsconfig" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Install dependencies with pnpm" prefix=" " level="3"}
...
The Tairo demo is split into differents nuxt layers. This allow to separate the marketing part from the documentation part, and to enable or disable features easily. 
