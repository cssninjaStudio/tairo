...
The base structure of Tairo starter is an empty Nuxt app that only extends from the Tairo layer.
...
You will find more information about the app structure in the [Nuxt and Layer](/documentation/setup/nuxt-and-layers) guide.
:::
