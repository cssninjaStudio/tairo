...
::code-timeline{.mt-12}
  ...
  #title
  :tairo-toc-anchor{label="Verify Node.js installation" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Install pnpm with corepack" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Verify pnpm installation" prefix=" " level="3"}
