...
<table class="mb-24" style="--tw-prose-td-borders: rgb(var(--color-muted-200));">
<tbody>
...
:::
  ...
  #title
  :tairo-toc-anchor{label="Choose a layout" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Add the layout to your project" prefix=" " level="3"}

  #description
  Depending if you are runing from source or with github layers, you can add the layout to your project. 
  ...
  #title
  :tairo-toc-anchor{label="Create the default layout" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Configure the layout" prefix=" " level="3"}
  ...
  #title
  :tairo-toc-anchor{label="Update the default app component" prefix=" " level="3"}
