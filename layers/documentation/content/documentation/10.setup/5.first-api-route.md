...
Now you have a page and an API route, you can connect them together. We will request the hello API route from the page created [on previous section](/documentation/setup/first-page) and display the result.
...
We've see that using :doc-linker{to="BaseInput"}, :doc-linker{to="BaseCard"} and :doc-linker{to="BaseParagraph"} components is very easy. You can also want to take a look a the [form validation](/documentation/guides/form-validation) guide and explore form demo pages to learn more about how to build forms with Tairo.
::
...
next: /documentation/setup/layout-configuration
---
::