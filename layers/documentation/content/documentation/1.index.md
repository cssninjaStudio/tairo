...
#grid
  ...
  :::doc-grid-icon{name="simple-icons:eslint" color="primary"}
  ESlint
  ...
  :::doc-grid-icon{name="file-icons:prettier" color="primary"}
  Prettier
  ...
  :::doc-grid-icon{name="akar-icons:vscode-fill" color="info"}
  VSCode
