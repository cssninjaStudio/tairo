...
- **Navigation Sidebar Item:** The icon sidebar is the frst part of the double sided navigation of the sidebar layout. It displays the logo and the main navigation icon links. Those links can be displayed as a link, a button that trigger an action.
...
- **Navigation Subsidebar:** The subsidebar works as a submenu element for each navigation item. It's a custom components that you have to create, we provide a set of components to help you to build it.
