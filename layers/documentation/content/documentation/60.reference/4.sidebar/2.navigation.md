...
title: Sidebar
---
The icon sidebar is the first part of the double sided navigation of the :doc-linker{to="TairoSidebarLayout"}. It displays the logo and the main navigation icon links. Those links can be configured in your `<app>/app/app.config.ts` file. They can be displayed as a link, a button or even trigger a function.
