...
To add `tools` to the toolbar or the circular menu, you have to create global components (meaning they need to be in the `components/global` folder), and add them to the `tools` array.
