...
Shuriken UI register a set of Tailwind plugin that contains components. Each of them can be customized using the `theme.extend.nui` object in the `tailwind.config.ts` file.
